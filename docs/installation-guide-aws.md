...
AWS CNI pod CIDR needs to be from the same private block as VPC and needs one subnet per AZ (3 usually and 2 for China). The sizing for subnet should be ideally atleast `/24` or `/25`. 
```
