...
- Remove `--audit-dynamic-configuration` flag from Kubernetes API server as it is not supported in `1.19.x`.
...
[Unreleased]: https://github.com/giantswarm/giantnetes-terraform/compare/v3.3.1...HEAD
